...
public sealed class PostgresMelSpectrogramAnalysisStoreTests
{
    [Fact]
    public void InitializeAndWrite_ShouldCreateTableAndInsertRows()
    {
        ...
        string tableName = PostgresTestEnvironment.CreateRandomTableName("t_mel_pg");

        try
        {
            using (PostgresMelSpectrogramAnalysisStore store = new(
                       connectionOptions,
                       sshOptions: null,
                       tableName,
                       anchorColumnName: "ms",
            ...
            {
                store.Initialize();
                store.Write(new MelSpectrogramAnalysisPoint("SongA", 0, 50, 10, CreateBins(4, -12.0)));
                store.Complete();
            }
    ...
    public void Write_ShouldClampBatchRowCount_WhenConfiguredBatchIsTooLarge()
    {
        ...
        try
        {
            ...
            {
                store.Initialize();
                store.Write(new MelSpectrogramAnalysisPoint("SongA", 0, 50, 10, CreateBins(binCount, -12.0)));
                store.Complete();
            }
    ...
    public void Write_ShouldUpsertAndSkipDuplicate()
    {
        ...
        try
        {
            ...
            {
                store.Initialize();
                store.Write(new MelSpectrogramAnalysisPoint("SongA", 0, 50, 10, CreateBins(4, -6.0)));
                store.Complete();
            }
            ...
            {
                store.Initialize();
                store.Write(new MelSpectrogramAnalysisPoint("SongA", 0, 50, 10, CreateBins(4, -2.0)));
                store.Write(new MelSpectrogramAnalysisPoint("SongA", 0, 50, 10, CreateBins(4, -2.0)));
                store.Complete();
            }
    ...
    public void Initialize_ShouldFail_WhenExistingBinCountDiffers()
    {
        ...
        try
        {
            using (PostgresMelSpectrogramAnalysisStore first = new(
                       connectionOptions,
                       sshOptions: null,
                       tableName,
                       anchorColumnName: "ms",
            ...
            {
                first.Initialize();
                first.Write(new MelSpectrogramAnalysisPoint("SongA", 0, 50, 10, CreateBins(4, -12.0)));
                first.Complete();
            }

            using PostgresMelSpectrogramAnalysisStore second = new(
                connectionOptions,
                sshOptions: null,
                tableName,
                anchorColumnName: "ms",
