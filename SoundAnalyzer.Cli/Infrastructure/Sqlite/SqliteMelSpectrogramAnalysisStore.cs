...
internal sealed class SqliteMelSpectrogramAnalysisStore : IMelSpectrogramAnalysisStore
{
    ...
    public SqliteMelSpectrogramAnalysisStore(
        string dbFilePath,
        string tableName,
    ...
    public void Initialize()
    {
        ...
        else if (tableExists)
        {
            ...
            if (schema.ContainsLegacyWideColumns)
            {
                ...
                throw new CliException(CliErrorCode.MelTableSchemaMismatch, detail);
            }
                ...
                && (coverage.MaxBinNo != binCount || coverage.DistinctBinCount != binCount))
            {
                ...
                throw new CliException(CliErrorCode.MelTableBinCountMismatch, detail);
            }
        }
    ...
    public void Write(MelSpectrogramAnalysisPoint point)
    {
        ...
        SqliteConnection currentConnection = connection
            ?? throw new InvalidOperationException("SqliteMelSpectrogramAnalysisStore is not initialized.");
    ...
    private static SqliteCommand BuildInsertCommand(
        ...
        string anchorColumnName,
        SqliteConflictMode conflictMode,
        MelSpectrogramAnalysisPoint point,
        long nowMs,
        int startBinNo,
        int rowCount)
    {
        ...
        string prefix = string.Create(
            CultureInfo.InvariantCulture,
            $"INSERT INTO {quotedTable} (\"audio_name\", \"ch\", \"window_size\", {quotedAnchorColumn}, \"bin_no\", \"db\", \"create_at\", \"modified_at\") VALUES ");

        string conflictColumns = string.Create(
            CultureInfo.InvariantCulture,
            $"\"audio_name\", \"ch\", \"window_size\", {quotedAnchorColumn}, \"bin_no\"");
