...
internal sealed class PostgresMelSpectrogramAnalysisStore : IMelSpectrogramAnalysisStore
{
    ...
    public PostgresMelSpectrogramAnalysisStore(
    ...
    public void Write(MelSpectrogramAnalysisPoint point)
    {
        ...
        NpgsqlConnection currentConnection = connection
            ?? throw new InvalidOperationException("PostgresMelSpectrogramAnalysisStore is not initialized.");
